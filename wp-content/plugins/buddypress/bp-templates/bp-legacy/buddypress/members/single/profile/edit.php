...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('.field_kan-medbringe-eget-utstyr .checkbox label input').on('change', function() {
			$('.field_kan-medbringe-eget-utstyr .checkbox label input').not(this).prop('checked', false);
		});
    ...
    $(function() {
      $("#field_116").after("<div class='antalltimerslider'></div>");
