...
function bp_legacy_theme_ajax_messages_autocomplete_results() {
	 ...
	 */
	$limit = isset( $_GET['limit'] ) ? absint( $_GET['limit'] ) : (int) apply_filters( 'bp_autocomplete_max_results', 999999
		);
...
/*endre labels på profilsiden*/
function bp_change_tabname() {

    global $bp;
    /*endre den første menyen*/
    $bp->bp_nav['profile']['name'] = 'Beskrivelse';
    $bp->bp_nav['settings']['name'] = 'Kontoinnstillinger';
    $bp->bp_nav['media-personal-li']['name'] = 'Galleri';
	$bp->bp_nav['reviews']['name'] = 'Kundeanmeldelser';

    /*endre undermenyen*/
        $bp->bp_options_nav['profile']['edit']['name'] = 'Rediger profilbeskrivelse';
        $bp->bp_options_nav['profile']['change-avatar']['name'] = 'Endre profilbilde';
