    ...
    public function preview()
    {
        ...
        if ($this->job_id) {
            ...
            <form method="post" id="job_preview" action="<?php echo esc_url($action); ?>">
                ...
                <h1 style="text-align:center">Forhåndsvisning</h1><br/>

                <p style="font-size:140%;">Nedenfor ser du en forhåndsvsining av hvordan din forespørsel vil se ut.
                    Dersom alt ser bra ut kan du poste forespørselen, og den vil bli synlig for artister omgående.</p>
