                ...
                if ((count($check_exit) < $options['limit'] or $options['limit'] == 0)) {
                    ...
                    <div id="whats-new-content">
                        ...
                        <div id="review-rating" >
                            Ranger: <img src="<?php echo DEPROURL ?>/images/star_off.png" class="star" id="star1">
                        ...
                        <div id="whats-new-options" style="height: 40px;">
                            <div id="whats-new-submit">
                                ...
                                <input type="submit" value="Post anmeldelse" id="whats-new-submit" name="review_member_submit">
                            </div>
                            <?php
    ...
    if (count($check_content_loop) > 0) {
        ...
        <div class="pagination" id="pag-top" style="margin-bottom:20px">
            <div id="group-dir-count-top" class="pag-count">
                <?= __('Viewing reviews 1 to','bpreviews') ?> <?php echo count($check_content_loop) ?>  (av <?php echo bp_core_get_username(bp_displayed_user_id()) ?> )
            </div>
        ...
        ?>
        <div id="message" class="info">
            <p><?php printf(__("Det er ingen kundeanmeldelser enda. <span class='bp-reviews-message'>Hva med &aring; skrive en?</span>", 'bpreviews')); ?></p>
        </div>
        <?php
    }
    ?>
...
?>
    ...
    <div id="message" class="info">
        <p><?php printf(__("Kundeanmeldelse er ikke mulig for denne profilen", 'bpreviews')); ?></p>
    </div>
    <?php } ?>
<?php
}
