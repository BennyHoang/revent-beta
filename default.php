...
<html>
    <head>
        <title>Velkommen til <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.no/"><img src="http://www.hostinger.no/images/logo-no.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Din konto er opprettet med hell!</h1>
                    <p>Nettstedet <? print $host; ?> har blitt installert på serveren! Vennligst slett filen default.php fra public_html mappen og deretter laste opp nettstedet ditt ved hjelp av FTP eller File Manager.</p>
                    <p>Her er en liste over filer i mappen public_html:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.no/nettside-hosting" target="_blank">Nettside Hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.no/gratis-hosting" target="_blank">Gratis Hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.no/forum" target="_blank">Brukerstøtte Forum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.no/" target="_blank">Client Login</a>
                </div>
                <div class="copyright">Hostinger Norge &copy; <? print date('Y'); ?>. All rights reserved</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.NO"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
