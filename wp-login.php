...
break;
	...
	/*Videreføre til riktig logg inn side*/

	/*Deaktivert inntillcooming soon mode er avslått*/
	wp_redirect( 'http://revent.no/logg-inn/', 301 ); exit;
